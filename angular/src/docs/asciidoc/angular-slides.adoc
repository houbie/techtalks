...
=== The JQuery solution
.http://localhost:3000/#/editable[X-editable example]
[source,html]
----
...
== MVC
.http://localhost:3000/#/mvc[MVC example]
[source,html]
----
...
=== Data Binding
.http://localhost:3000/#/binding[Binding example]
[source,html]
----
...
=== Watch expressions
.http://localhost:3000/#/watch[Watch example]
[source,javascript]
----
...
=== Dependency Injection
.http://localhost:3000/#/di[DI example]
[source,javascript]
----
...
== Ajax
=== $http
.http://localhost:3000/#/http[$http example]
[source,javascript]
----
